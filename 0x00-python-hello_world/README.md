# The directory named -0x00-python-hello_world

It contains solutions on the mandatory tasks from 0 to 10 and advanced task
from 11 to 13 on python hello world
here are task description
